...
def parse_opt(known=False):
    ...
    parser.add_argument("--optimizer", type=str, choices=optimizer_list, default="SGD", help="optimizer")
    ...
    parser.add_argument("--cos-lr", default=False, help="cosine LR scheduler")
